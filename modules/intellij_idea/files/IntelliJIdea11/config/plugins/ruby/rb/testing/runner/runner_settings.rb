...
module IntelliJ
  ...
  # TestUnit run Class
  QUALIFIED_CLASS_NAME = ENV["INTELLIJ_IDEA_RUN_CONF_QUALIFIED_CLASS_NAME"]
  ...
  # TestUnit run Class
  # TestUnit run all in folder
  IDEA_TUNIT_RUNNER_CLASS_NAME = ENV["INTELLIJ_IDEA_RUN_CONF_IDEA_TUNIT_RUNNER_CLASS_NAME"]

  # TestUnit run Class
  # TestUnit run all in folder
  IDEA_TUNIT_RUNNER_PATH = ENV["INTELLIJ_IDEA_RUN_CONF_IDEA_TUNIT_RUNNER_PATH"]
  ...
  TEST_UNIT_RUNNER_PATH = USE_CONSOLE_RUNNER ? 'test/unit/ui/console/testrunner' : IDEA_TUNIT_RUNNER_PATH
  def self.get_test_unit_runner_class
    USE_CONSOLE_RUNNER ? Test::Unit::UI::Console::TestRunner : eval(IDEA_TUNIT_RUNNER_CLASS_NAME);
  end
