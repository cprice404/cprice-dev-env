...
require File.dirname(__FILE__) + '/controller_action_ref_param'
...
class Rails3ParamDefsLoader < BaseParamDefsLoader
  ...
  def registerParamDefs(manager)
    ...
    # Active Record
    calculators = %w{average count maximum minimum sum}
    ...
    define_params_copy 'ActiveRecord::Base::calculate', 'ActiveRecord::Calculations::ClassMethods::calculate'
    define_params_copy 'ActiveRecord::Calculations::calculate', 'ActiveRecord::Calculations::ClassMethods::calculate'
    ...
    paramdef_arel ['where', 'having'], nil
    ...
    paramdef 'ActiveModel::Validations::ClassMethods', 'validates', one_str_literal_or_more_of(migration_ref),
             {:acceptance => bool, :confirmation => bool, :inclusion => nil,
              :exclusion => nil,:numericality => bool, :presence => bool, :uniqueness => either(bool, {:case_sensitive => bool}),
